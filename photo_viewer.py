# -*- coding: utf-8 -*-
"""
Created on Wed Apr 12 15:01:56 2023
...
def make_gallary():
    def forward(img_no):
        ...
        label = Label(gallary,image=List_images[img_no-1])
    ...
    gallary.title("Image Viewer")
     
    # The geometry of the box which will be displayed
    # on the screen
    gallary.geometry("700x700")
    ...
    image_no_1 = ImageTk.PhotoImage(Image.open(r"C:\Users\lawashburn\Documents\MSI_test\gui_test\20230411\cell_number_14.png"))
    image_no_2 = ImageTk.PhotoImage(Image.open(r"C:\Users\lawashburn\Documents\MSI_test\gui_test\20230411\cell_number_42.png"))
    image_no_3 = ImageTk.PhotoImage(Image.open(r"C:\Users\lawashburn\Documents\MSI_test\gui_test\20230411\cell_number_38.png"))
    image_no_4 = ImageTk.PhotoImage(Image.open(r"C:\Users\lawashburn\Documents\MSI_test\gui_test\20230411\cell_number_3.png"))
     
    # List of the images so that we traverse the list
    List_images = [image_no_1, image_no_2, image_no_3, image_no_4]
     
    label = Label(gallary,image=image_no_1)
     
    # # We have to show the box so this below line is needed
    label.grid(row=1, column=0, columnspan=3)
     
    # We will have three button back ,forward and exit
    button_back = Button(gallary, text="Back", command=back,
                          state=DISABLED)
     
    # root.quit for closing the app
    button_exit = Button(gallary, text="Exit",
                          command=gallary.quit)
     
    button_forward = Button(gallary, text="Forward",
